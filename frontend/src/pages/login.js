// login.js  ─  CampusFlow Sign In Page
// Props: onGoHome, onGoSignup
...
export default function Login({
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      {/* Ambient orbs */}
      <div
        className="fixed top-1/4 -left-20 w-80 h-80 rounded-full pointer-events-none orb1"
        style={{
      ...
      />
      <div
        className="fixed bottom-1/4 -right-20 w-64 h-64 rounded-full pointer-events-none orb2"
        style={{
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <div className="relative mb-8">
            ...
            >
              Sign in to <span className="shimmer">CampusFlow</span>
            </h1>
            <p className="text-sm text-white/35">Your campus command centre awaits.</p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 rounded-2xl text-white font-bold text-sm transition-all duration-300 hover:-translate-y-0.5 relative overflow-hidden"
            style={{
